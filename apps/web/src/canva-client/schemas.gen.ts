...
(in seconds since the Unix Epoch).`,
  ...
  required: ['create_url', 'created_at', 'id', 'title', 'updated_at', 'view_url'],
  type: 'object',
} as const;
...
export const $ShareDesignNotificationContent = {
  ...
  required: ['design', 'receiving_team_user', 'share_url', 'triggering_user', 'type'],
  type: 'object',
} as const;
...
export const $CommentNotificationContent = {
  ...
  required: ['comment', 'comment_url', 'design', 'receiving_team_user', 'triggering_user', 'type'],
  type: 'object',
} as const;
...
design, that approves the requested access.`,
  ...
  required: ['design', 'grant_access_url', 'receiving_team_user', 'triggering_user', 'type'],
  type: 'object',
} as const;
