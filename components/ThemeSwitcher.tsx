...
const ThemeSwitcher = () => {
  ...
  const themes = (value: string) => {
    return ` ${value === currTheme ? "dark:text-[#fafafa]" : "text-[#8f8f8f] hover:dark:text-[#fafafa] hover:text-[#000000]"}`
  }
  return (
    <div className="flex space-x-4">
      <span className="h-full flex items-center">
        <input id="theme-switch-system" type="radio" value="system" className="hidden" onClick={() => applyTheme("system")} />
        <label
      ...
      <span className="h-full flex items-center">
        <input id="theme-switch-light" type="radio" value="light" className="hidden" onClick={() => applyTheme("light")} />
        <label
      ...
      <span className="h-full flex items-center">
        <input id="theme-switch-dark" type="radio" value="dark" className="hidden" onClick={() => applyTheme("dark")} />
        <label
